...
${OBJECTDIR}/src/cola_max.o: src/cola_max.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cola_max.o src/cola_max.cpp

${OBJECTDIR}/src/maxqueue.o: src/maxqueue.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maxqueue.o src/maxqueue.cpp

${OBJECTDIR}/src/maxstack.o: src/maxstack.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maxstack.o src/maxstack.cpp

${OBJECTDIR}/src/pila_max.o: src/pila_max.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pila_max.o src/pila_max.cpp
